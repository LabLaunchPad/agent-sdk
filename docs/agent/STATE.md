...
| Current phase              | Phase 1B — Architecture Reconciliation & ADR Freeze (complete)                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Phase status               | Phase 1B complete: 8 binding ADRs (0009-0016), all 27 boundaries dispositioned, all 12 ACTION_REQUIRED items resolved, first E5 executed, post-commit-ops DEFERRED, 7th validator added. Phase 2 spec-preparation may begin (`SPEC_GATE: PARTIAL`) — see `docs/agent/NOW.md`. Preceded by P1A (OKF v0.2 Adoption + Gap Audit, Workstream B: original-brief sources live-researched, 2 of 17 remain UNKNOWN — Volcengine, Baidu; see `.context/research/gaps.json` — + 5 imported corpora + canonical consolidation) |
...
- Workstream B (gap audit): original-brief sources live-researched; 2 of 17
  remain fully `UNKNOWN` (Volcengine AgentKit, Baidu AppBuilder SDK —
  deliberately not researched in Phase 1B, no pending ADR needs them). 5
...
- `research/canonical/` — a supplementary cross-corpus consolidation graph
  ...
  (Phase 1B). `GAP-E5-ZERO` is **partially addressed** (1 of 10+ named
