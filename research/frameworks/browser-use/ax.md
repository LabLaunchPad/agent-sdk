...
title: Browser Use — Ax
description: 'ax dimension research for browser-use, imported from a prior external research pass'
sources:
...
AI-agent ergonomics benefit from a small primitive vocabulary and clear task-oriented docs. Skills provide a reusable capability interface.

**Adopt:** one minimal “do task in environment” path before introducing workflow graphs or role hierarchies.
