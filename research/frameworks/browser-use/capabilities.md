...
title: Browser Use — Capabilities
description: 'capabilities dimension research for browser-use, imported from a prior external research pass'
sources:
...
Core capability is browser automation: page interaction, navigation, forms, extraction, downloads, authenticated profiles and integrations. Cloud adds managed browser/session/workspace infrastructure.

Classification: **LOCAL_CAPABLE + MANAGED REMOTE**. The browser is the primary sandboxed capability surface; permissions and network egress remain critical concerns.
