...
title: Browser Use — Context
description: 'context dimension research for browser-use, imported from a prior external research pass'
sources:
...
Skills are selectively loaded by IDs; the docs warn that each skill contributes roughly 200 tokens to the prompt when included. This is direct evidence that capability discovery itself has a context cost.

**LabLaunchPad benchmark:** skill-discovery tokens, context load, tool count, task success.
