...
title: Browser Use — Memory
description: 'memory dimension research for browser-use, imported from a prior external research pass'
sources:
...
Browser Use is not a memory-first framework. Reusable skills function more like compiled procedures/capabilities than personal memory.

**Lesson:** not every agent needs first-class long-term memory; default to deterministic reusable capabilities when repeatability is the goal.
