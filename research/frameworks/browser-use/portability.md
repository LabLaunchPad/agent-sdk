...
title: Browser Use — Portability
description: 'portability dimension research for browser-use, imported from a prior external research pass'
sources:
...
Mapping: Browser Use Agent -> LabLaunchPad Agent + BrowserCapability; Session -> Run + BrowserSession; Skill -> CapabilityPackage; Sandbox -> BrowserRuntime/SandboxContract.

Do not model browser tasks as multi-agent workflows unless the user actually needs branching/orchestration.
