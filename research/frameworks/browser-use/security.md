...
title: Browser Use — Security
description: 'security dimension research for browser-use, imported from a prior external research pass'
sources:
...
The reviewed docs emphasize managed browser isolation, profiles/auth and cloud execution, but do not present a unified general-purpose tool security analyzer like OpenHands. Browser sessions themselves are privileged environments and may hold cookies or authenticated state.

**LabLaunchPad requirement:** treat browser credentials, network targets and downloads as individually permissioned capabilities.
