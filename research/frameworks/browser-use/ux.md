...
title: Browser Use — Ux
description: 'ux dimension research for browser-use, imported from a prior external research pass'
sources:
...
The operator mental model is task/session/browser, not crew/team. The important state is current browser session, profile/auth, execution result and reusable skill.

LabLaunchPad should offer a similarly compact “Run” view for simple agents.
