...
title: CrewAI — Ax
description: 'ax dimension research for crewai, imported from a prior external research pass'
sources:
...
CrewAI publishes current docs and official coding-agent skills. This is a strong pattern for repository-agent ergonomics: give coding agents exact project scaffolding and API guidance.

LabLaunchPad should maintain versioned agent-facing skills for its own repository.
