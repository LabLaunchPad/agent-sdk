...
description: 'capabilities dimension research for crewai, imported from a prior external research pass'
sources:
...
Agents expose tools, memory, knowledge and structured output. Tasks support callbacks and guardrails; Flows expose routing and state; enterprise deployment provides API/observability/tool repositories in managed infrastructure.

Classification: **LOCAL + REMOTE/MANAGED**, with clear framework-vs-platform separation.
