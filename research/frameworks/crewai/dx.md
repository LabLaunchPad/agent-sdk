...
title: CrewAI — Dx
description: 'dx dimension research for crewai, imported from a prior external research pass'
sources:
...
Role/goal/backstory is highly approachable for business automation and makes collaboration intent explicit. The cost is concept multiplication: Agent, Task, Crew, Flow, Process, Memory, Knowledge, Guardrails.

**UX rule:** hide advanced orchestration behind progressive disclosure.
