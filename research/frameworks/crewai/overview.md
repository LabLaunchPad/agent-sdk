...
description: 'overview dimension research for crewai, imported from a prior external research pass'
sources:
...
CrewAI centers on role-oriented multi-agent collaboration plus two orchestration modes: autonomous Crews and structured Flows. Current docs position Flows as the more deterministic production architecture, while Crews optimize for flexible collaboration.

**Primary JTBD:** compose specialized agents around role/task semantics and automate business workflows.
**Unique strength:** intuitive role/task/crew mental model and a clear transition from autonomous collaboration to structured orchestration.
