...
title: CrewAI — Runtime
description: 'runtime dimension research for crewai, imported from a prior external research pass'
sources:
...
Open-source CrewAI runs locally; CrewAI AMP supplies managed deployment, APIs, monitoring, streaming and studio.

**Neutral runtime lesson:** the framework should produce a portable execution specification; managed control-plane features should consume it rather than redefine semantics.
