...
title: Google Agent Development Kit (ADK) — Ax
description: 'ax dimension research for google-adk, imported from a prior external research pass'
sources:
...
# Google Agent Development Kit (ADK) — Ax
...
ADK explicitly publishes llms.txt/llms-full.txt and an Agents CLI with skills for AI coding. This is a strong machine-consumption pattern: documentation becomes part of the developer interface.

LabLaunchPad should publish versioned context packs for agents, not only human docs.
