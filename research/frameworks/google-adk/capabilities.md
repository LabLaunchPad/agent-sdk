...
title: Google Agent Development Kit (ADK) — Capabilities
description: 'capabilities dimension research for google-adk, imported from a prior external research pass'
sources:
...
# Google Agent Development Kit (ADK) — Capabilities
...
ADK offers custom/MCP/OpenAPI tools, skills, artifacts, callbacks/plugins, model routing and A2A. It spans Python, TypeScript, Go, Java and Kotlin.

Classification: **LOCAL_CAPABLE + REMOTE + MANAGED**. Tool integrations and deployment are separated from the base agent interface, which is good modularity.
