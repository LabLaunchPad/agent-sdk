...
title: Google Agent Development Kit (ADK) — Dx
description: 'dx dimension research for google-adk, imported from a prior external research pass'
sources:
...
# Google Agent Development Kit (ADK) — Dx
...
DX strength: start with a simple agent and progressively add multi-agent, graphs, eval and deployment; supports AI-assisted coding with LLM-friendly docs. DX cost: many languages and runtime/platform pathways increase compatibility/testing burden.

**Recommendation:** keep LabLaunchPad's core language-neutral semantics, with thin language bindings.
