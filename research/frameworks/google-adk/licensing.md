...
title: Google Agent Development Kit (ADK) — Licensing
description: 'licensing dimension research for google-adk, imported from a prior external research pass'
sources:
...
# Google Agent Development Kit (ADK) — Licensing
...
- Repository license: **Apache-2.0** according to the official repository/source listed above.
