...
title: Google Agent Development Kit (ADK) — Tradeoffs
description: 'tradeoffs dimension research for google-adk, imported from a prior external research pass'
sources:
...
# Google Agent Development Kit (ADK) — Tradeoffs
...
**Strengths:** lifecycle completeness, graph workflows, multi-language support, evaluation and deployment.
**Weaknesses:** large surface area and stronger platform adjacency.
**Likely durable:** event/session/state contracts, workflow composition, eval hooks.
**Likely to shrink:** some manually defined routing/prompt glue as models improve.
