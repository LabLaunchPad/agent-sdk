...
title: Letta Agent SDK / Letta — Tradeoffs
description: 'tradeoffs dimension research for letta, imported from a prior external research pass'
sources:
...
# Letta Agent SDK / Letta — Tradeoffs
...
**Strengths:** explicit durable identity and memory semantics.
**Weaknesses:** memory correctness becomes a hard systems problem; always-visible blocks consume context.
**Likely durable:** distinction between state, memory, files and archival retrieval.
**Likely to shrink:** some hand-authored memory-management prompts as models get better at structured state updates.
