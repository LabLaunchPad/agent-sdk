...
title: Letta Agent SDK / Letta — Ux
description: 'ux dimension research for letta, imported from a prior external research pass'
sources:
...
The central UX pattern is inspectable agent memory: users/operators can see, update, attach and detach blocks. This is more actionable than an opaque “memory enabled” toggle.

Adopt a provenance-aware memory inspector showing source, scope, last update, write actor and expiry/review status.
