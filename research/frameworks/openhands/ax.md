...
title: OpenHands Software Agent SDK — Ax
description: 'ax dimension research for openhands, imported from a prior external research pass'
sources:
...
# OpenHands Software Agent SDK — Ax
...
For an AI coding agent operating the repo, the docs themselves provide structured/LLM-friendly indexing and explicit skill formats. That improves machine discoverability. The remaining risk is architectural rediscovery across many packages and execution boundaries.

**Lesson:** machine-readable documentation should be treated as a first-class repo interface.
