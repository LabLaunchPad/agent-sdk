...
title: OpenHands Software Agent SDK — Evaluation
description: 'evaluation dimension research for openhands, imported from a prior external research pass'
sources:
...
# OpenHands Software Agent SDK — Evaluation
...
OpenHands documents tests, observability/tracing, stuck detection, goal completion and conversation persistence, but the reviewed sources do not establish a single universal end-to-end evaluation protocol comparable to ADK trajectory criteria.

**LabLaunchPad:** require outcome evals plus trace/trajectory checks and resource-budget metrics; reproduce before treating SDK claims as verified.
