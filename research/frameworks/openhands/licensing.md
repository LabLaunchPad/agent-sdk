...
title: OpenHands Software Agent SDK — Licensing
description: 'licensing dimension research for openhands, imported from a prior external research pass'
sources:
...
# OpenHands Software Agent SDK — Licensing
