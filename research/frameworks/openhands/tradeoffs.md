...
title: OpenHands Software Agent SDK — Tradeoffs
description: 'tradeoffs dimension research for openhands, imported from a prior external research pass'
sources:
...
# OpenHands Software Agent SDK — Tradeoffs
...
**Strengths:** software-native, rich workspaces, persistence, action security, remote execution.
**Weaknesses:** larger concept surface and policy complexity.
**Likely durable:** event log, workspace contract, capability boundary.
**Likely to shrink:** framework-specific skill syntax and some orchestration helpers as models improve.
